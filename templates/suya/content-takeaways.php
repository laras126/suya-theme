...
<section class="sy--takeaways">
	...
	<div class="row text-center">
		...
		<div class="sy-section sy-third">
			...
			<p class="small"><?php the_field('takeaway_center_blurb'); ?></p>
		</div>
		<div class="sy-section sy-third">
			<div class="text-center sy-icon">
			...
			<p class="small"><?php the_field('takeaway_right_blurb'); ?></p>
		</div>
	</div>
	<?php edit_post_link(); ?>
</section>
